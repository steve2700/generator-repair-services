...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'generator repair Diepkloof',
    'generator repair Meadowlands',
    'generator repair Orlando',
    'generator repair Pimville',
    'generator repair Protea Glen',
    'emergency generator repair Soweto',
    'generator servicing Soweto',
...
const sowetoAreas = [
  'Diepkloof', 'Meadowlands', 'Orlando', 'Pimville', 'Protea Glen',
  'Dobsonville', 'Naledi', 'Chiawelo', 'Moletsane', 'Tladi',
  'Soweto CBD', 'Rockville', 'Dlamini', 'Phiri', 'Jabulani',
  'Noordgesig', 'Eldorado Park', 'Ennerdale', 'Orange Farm', 'Kliptown',
]
...
const whyPoints = [
  {
    ...
    body: 'Our technicians arrive at your Soweto site fully equipped. Most repairs are completed on the first visit — no towing, no drop-off, no waiting.',
  },
  {
    num: '02',
    title: 'Same-day emergency response',
    body: 'When loadshedding or a fault takes your generator down, we mobilise fast. Most Soweto callouts receive a technician within 2–4 hours.',
  },
  {
    num: '03',
    title: 'Transparent, affordable pricing',
    body: 'We understand the importance of value. Our pricing is competitive and fully transparent — you receive a clear quote before any work begins.',
  },
  {
    num: '04',
    title: 'All makes and sizes',
    body: 'Cummins, Perkins, Caterpillar, Deutz, and more — residential, commercial and industrial generators serviced across the full kVA range.',
  },
]
      ...
      <section className="relative bg-[#0a0a0a] overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 py-16 md:py-24">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-[3.5rem] font-black text-white leading-[1.08] mb-6 max-w-3xl">
            Generator Repairs in Soweto.<br />
          ...
          <p className="text-white/60 text-lg md:text-xl leading-relaxed max-w-2xl mb-8">
            From Diepkloof and Meadowlands through to Protea Glen and Orlando —
            our mobile technicians cover all of Soweto, arriving equipped to diagnose
            and repair on-site the same day.
          </p>

          <div className="flex flex-wrap gap-x-6 gap-y-3 mb-10">
            {['Same-day emergency callouts', 'All generator makes & sizes', 'On-site repairs, first visit', 'Transparent, affordable pricing'].map((t) => (
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="mb-10">
            ...
            <h2 id="why-heading" className="text-2xl md:text-3xl font-black text-[#0a0a0a]">
              Generator Service Built for Soweto
            </h2>
          </div>
      ...
      <section className="py-16 md:py-20 bg-white" aria-labelledby="detail-heading">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-[1fr_360px] gap-12 lg:gap-20 items-start">
            ...
            {/* Left — body copy */}
            <div>
              <p className="text-[#c8a84b] text-[11px] font-bold tracking-[0.35em] uppercase mb-2">Soweto</p>
              <h2 id="detail-heading" className="text-2xl md:text-3xl font-black text-[#0a0a0a] mb-6">
                Expert Generator Service Across All of Soweto
              </h2>
              <div className="w-10 h-0.5 bg-[#c8a84b] mb-8" />
              <div className="space-y-5 text-base md:text-lg leading-relaxed text-[#1a1a1a]/70">
                <p>
                  Soweto is a vibrant economic hub with a rapidly growing base of businesses,
                ...
                <p>
                  Our coverage spans the full Soweto area. From Diepkloof, Meadowlands,
                  and Orlando in the west, through Pimville and Chiawelo, to Protea Glen,
                  Dobsonville, and Naledi — our mobile technicians reach you. We carry
                  diagnostic equipment and a comprehensive stock of common parts, meaning
                  most faults are diagnosed and repaired in a single visit without the need
                  for return trips.
                </p>
                <p>
                  Emergency callouts in Soweto receive priority response. When your generator
                  fails during an outage, we assess your situation on the call, dispatch
                  accordingly, and communicate upfront about arrival time, fault diagnosis,
                  and repair cost before any work begins. Our pricing is transparent and
                  competitive — no hidden charges, no surprises on the invoice.
                </p>
                <p>
                  Beyond emergency repairs, we offer scheduled servicing and maintenance
                  contracts for businesses, schools, clinics, and residential estates that
                  need their generators to start reliably every time. A properly maintained
                  generator is a far more cost-effective asset than one that only gets
                  attention when it fails completely.
                </p>
              </div>

              {/* Soweto suburbs coverage box */}
            ...
            {/* Right — services */}
            <div>
              <p className="text-[#c8a84b] text-[11px] font-bold tracking-[0.35em] uppercase mb-5">Services in Soweto</p>
              {services.map((item, i) => (
                <Link
                  key={item.href}
                  href={item.href}
        ...
        <div className="max-w-6xl mx-auto px-6 py-14 md:py-18">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
            <div className="max-w-xl">
              <h2 className="text-2xl md:text-3xl font-black mb-3">Need Generator Service in Soweto?</h2>
              <p className="text-white/55 text-base leading-relaxed">
                Emergency or planned, we cover all of Soweto. Call now for a
